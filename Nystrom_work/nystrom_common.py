# -*- coding: utf-8 -*-
"""Nystrom_common.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19JoAS-TJy65GdKeTxvtAuNdUTezaLXqD
...
class Nystrom_common:
    ...
    def fit(self, x):
        ...
        # Basic checks
        assert self.tools.is_tensor(x), 'Input to fit(.) must be an array if using numpy and tensor if using torch.'
    ...
    def _Gauss_block_sparse_pre(self, x, y, K_ij):
        ...
        Args: 
            x[np.array or torch.tensor], y[np.array or torch.tensor] = arrays/tensors giving rise to Gaussian kernel K(x,y)
            K_ij[LazyTensor] = symbolic representation of K(x,y)
            eps[float] = size for square bins
        Returns:
            K_ij[LazyTensor] = symbolic representation of K(x,y) with 
                                set sparse ranges
        '''
